...
\title{\textbf{\'Atomo de Hidr\'ogeno Relativista}\\ % Title
 en el formalismo de Dirac} % Subtitle

\author{\textsc{Juan Nicol\'as Garavito Camargo \\ Juan David Orjuela Z\'u\~niga} % Author
...
\begin{abstract}
En este trabajo se estudia la soluci\'on al \'Atomo de Hidr\'ogeno en el formalismo de Dirac.
...
\end{abstract}
\hspace*{3,6mm}\textit{Keywords: Potencial tipo Coulomb, Ecuaci\'on de Dirac, Relatividad, Sp\'in. }  % Keywords
...
\caption{Niveles de energ\'ia provenientes de la soluci\'on de las ecuaciones de Dirac (izquierda) y Schr\"odinger (derecha) para el \'atomo de Uranio (Z=92).
...
Se calcul\'o con mucha exactitud los niveles de energ\'ia del \'atomo de Hidr\'ogeno. Esta expresi\'on es en general v\'alida para muchos otros \'atomos pero la precisi\'on dismuniye (al ignorar la interacci\'on con los otros electrones). Dado que la ecuaci\'on de Dirac es relativista y predice la existencia del n\'umero cu\'antico de esp\'in, y el espectro predicho concuerda muy bien con las l\'ineas de emisi\'on observadas en el experimento, este hecho sirve como confirmaci\'on de que el electr\'on es una part\'icula de esp\'in $s=1/2$. Comentar lo del poder predictivo de la teor\'ia formal, a diferencia del tratamiento fenomenol\'ogico de Pauli, o Uhlenbeck.
